...
#ifndef PB_PROTOMESSAGES_MESSAGEDATA_PB_H_INCLUDED
#define PB_PROTOMESSAGES_MESSAGEDATA_PB_H_INCLUDED
#include <pb.h>
...
typedef enum _MessageData_MessageType {
    ...
    MessageData_MessageType_CHANGE_RGB_MATRIX_ANIMATION = 1,
    MessageData_MessageType_CHANGE_RGB_UNDERGLOW_ANIMATION = 2,
    MessageData_MessageType_CHANGE_OLED_ANIMATION = 3,
    MessageData_MessageType_OLED_FRAME_UPDATE = 10,
    MessageData_MessageType_UPDATE_KEYBINDINGS = 11
...
#define _MessageData_MessageType_MAX MessageData_MessageType_UPDATE_KEYBINDINGS
#define _MessageData_MessageType_ARRAYSIZE ((MessageData_MessageType)(MessageData_MessageType_UPDATE_KEYBINDINGS+1))
