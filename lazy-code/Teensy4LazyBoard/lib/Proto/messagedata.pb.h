...
#define _MessageData_MessageType_MAX MessageData_MessageType_PROGRAM_DISPLAY
#define _MessageData_MessageType_ARRAYSIZE ((MessageData_MessageType)(MessageData_MessageType_PROGRAM_DISPLAY+1))
